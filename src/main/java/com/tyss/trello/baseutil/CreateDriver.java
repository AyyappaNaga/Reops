...
public class CreateDriver {
	...
	public String userDataChromePath = System.getProperty("user.home") + "\\AppData\\Local\\Google\\Chrome\\UserData";
	public String userDataEdgePath = System.getProperty("user.home") + "\\AppData\\Local\\Microsoft\\Edge\\UserData";
	public String userDataOperaPath = System.getProperty("user.home")
			+ "\\AppData\\Local\\Opera Software\\Opera\\UserData";
	public String operaProxy = "77.111.246.20";
	...
	/**
	 * Description : getInstance method to retrieve active driver instance
	 *
	 * @author Sajal
	 * @return CreateDriver
	 */
	 ...
	 * @param browserName
	 */
	public void setDriverExecutables(String browserName) {
		try {
	 ...
	 * @param browserName
	 */
	public void killBrowserTask(String browserName) {
		try {
			if (browserName.equalsIgnoreCase("chrome")) {
